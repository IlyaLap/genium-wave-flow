...
export function SplashCursor({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // @ts-ignore - this is a custom constructor
      ...
      try {
        ...
        setErrorMessage(`WebGL context error: ${e instanceof Error ? e.message : String(e)}`);
      ...
      function initFramebuffers() {
        try {
          ...
          console.error("Error initializing framebuffers:", e);
          throw new Error(`Framebuffer initialization error: ${e instanceof Error ? e.message : String(e)}`);
        }
      }
      ...
      function updateFrame() {
        try {
          ...
          // Don't set error state here to avoid stopping the animation completely
        ...
        document.body.addEventListener(
          ...
          function handleFirstMouseMove(e) {
            try {
              ...
              console.error("Error in first mousemove handler:", err);
            }
          }
        );
        ...
        document.body.addEventListener(
          ...
          function handleFirstTouchStart(e) {
            try {
              ...
              console.error("Error in first touchstart handler:", err);
            }
          }
        );
      ...
      console.error("Fatal error in SplashCursor component:", e);
      setErrorMessage(`Fatal error in fluid animation: ${e instanceof Error ? e.message : String(e)}`);
    }
  }, [
    SIM_RESOLUTION,
    DYE_RESOLUTION,
  ...
  // Show fallback or error message if WebGL isn't supported
  if (!webGLSupported || errorMessage) {
    return (
      <div className="fixed top-0 left-0 z-0 w-screen h-screen bg-gradient-to-br from-purple-900 to-black">
        {errorMessage && (
          <div className="hidden">
            {/* We hide the error but log it to console */}
